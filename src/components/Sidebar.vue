<template>
  ...
  >
    ...
    <perfect-scrollbar>
      ...
      <div class="mb-4 px-4">
        <p class="pl-4 text-sm font-semibold mb-1">HDC</p>
        <router-link
          to="/data-pelamar"
          class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
        >
      ...
      <div class="mb-4 px-4">
        <p class="pl-4 text-sm font-semibold mb-1">Kaprodi</p>
        <div>
          <router-link
            to="/data-pelamar"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
        ...
        <div>
          ...
          >
            ...
            <span class="text-gray-700">Form Interview 1</span>
          </router-link>
        </div>
        <div>
          <router-link
          ...
          >
            ...
            <span class="text-gray-700">Nilai Interview 1</span>
          </router-link>
        </div>
        <div>
          <router-link
      ...
      <div class="mb-4 px-4">
        ...
        <div>
          ...
          >
            ...
            <span class="text-gray-700">Form Interview 2</span>
          </router-link>
        </div>
        <div>
          <router-link
          ...
          >
            ...
            <span class="text-gray-700">Nilai Interview 2</span>
          </router-link>
        </div>
        <router-link
          to="/pengumuman"
