    ...
    <perfect-scrollbar>
      ...
      <div
        ...
        v-if="
          profile.role === 'HCD' ||
            profile.role === 'Admin' ||
            profile.role === 'Kaprodi' ||
            profile.role === 'Rektorat'
        "
      >
        <p class="pl-4 text-sm font-semibold mb-1">Data Pelamar</p>
      ...
      <div
        class="mb-4 px-4"
        v-if="profile.role === 'Kaprodi' || profile.role === 'Admin'"
      >
        <div class="mb-4 px-0">
      ...
      >
        <p class="pl-4 text-sm font-semibold mb-1">Pimpinan/Rektorat</p>
