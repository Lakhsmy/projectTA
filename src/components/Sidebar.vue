<template>
  ...
  >
    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <img class="object-cover max-h-20" src="~@/assets/upj.png" />
    </div>
    <perfect-scrollbar>
      <div class="mb-4 px-4">
        ...
        >
          ...
          <span class="text-gray-700">Kualifikasi</span>
        </router-link>
        <router-link
          to="/alur"
          exact
        ...
        >
          ...
          <span class="text-gray-700">Alur</span>
        </router-link>
        <!-- <router-link
          to="/job"
          exact
        ...
        >
          ...
          <span class="text-gray-700">Psikotest</span>
        </router-link>
        <<<<<<< HEAD =======
      </div>
      ...
      <div
        class="mb-4 px-4"
        v-if="profile.role === 'HCD' || profile.role === 'Admin'"
      >
        <p class="pl-4 text-sm font-semibold mb-1">HCD</p>
        ...
        >
          ...
          <span class="text-gray-700">Data Pelamar</span>
        </router-link>
      </div>
      ...
      <div class="mb-4 px-4">
        ...
        >
          ...
          <span class="text-gray-700">Nilai Psikotest</span>
        </router-link>
        <div>
          <router-link
            to="/lolos-psikotest"
          ...
          >
            ...
            <span class="text-gray-700">Peserta Lolos Psikotest</span>
          </router-link>
        </div>
        <div>
          <router-link
          ...
          >
            ...
            <span class="text-gray-700">Pengumuman Psikotest</span>
          </router-link>
        </div>
      </div>

      <div class="mb-4 px-4">
        <p class="pl-4 text-sm font-semibold mb-1">Kaprodi/Dosen</p>
        <div>
          <router-link
            to="/form-interview-satu"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <<<<<<< HEAD
            <span class="text-gray-700">Form Interview</span>
            =======
            <span class="text-gray-700">Form Wawancara 1</span>
            >>>>>>> d548ab41c6b923fbc72aea94abff93d81550778d
          </router-link>
        </div>
        <div>
          <router-link
            to="/nilai-interview-satu"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <<<<<<< HEAD
            <span class="text-gray-700">Nilai Interview</span>
            =======
            <span class="text-gray-700">Nilai Wawancara 1</span>
            >>>>>>> d548ab41c6b923fbc72aea94abff93d81550778d
          </router-link>
        </div>
        <div>
          <router-link
            to="/form-mikroteaching"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <span class="text-gray-700">Form Nilai Microteaching</span>
          </router-link>
        </div>
        <div>
          <router-link
            to="/nilai-mikroteaching"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <span class="text-gray-700">Nilai Microteaching</span>
          </router-link>
        </div>
        <router-link
          to="/pengumuman"
        ...
        >
          ...
          <span class="text-gray-700">Pengumuman Tahap 1</span>
        </router-link>
      </div>

      <div
        class="mb-4 px-4"
        v-if="profile.role === 'Rektorat' || profile.role === 'Admin'"
      >
        <p class="pl-4 text-sm font-semibold mb-1">Rektorat</p>

        <div>
          <router-link
            to="/form-interview-dua"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <<<<<<< HEAD
            <span class="text-gray-700">Form Evaluation</span>
            =======
            <span class="text-gray-700">Form Wawancara 2</span>
            >>>>>>> d548ab41c6b923fbc72aea94abff93d81550778d
          </router-link>
        </div>
        <div>
          <router-link
            to="/nilai-interview-dua"
            exact
            exact-active-class="bg-gray-200"
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
          >
            ...
            <<<<<<< HEAD
            <span class="text-gray-700">Nilai Evaluation</span>
            =======
            <span class="text-gray-700">Nilai Wawancara 2</span>
            >>>>>>> d548ab41c6b923fbc72aea94abff93d81550778d
          </router-link>
        </div>
        <router-link
        ...
        >
          ...
          <span class="text-gray-700">Pengumuman Evaluation</span>
        </router-link>
      </div>
      <div class="mb-4 px-4" v-if="profile.role === 'Admin'">
        <p class="pl-4 text-sm font-semibold mb-1">Question</p>
        <router-link
          to="/question-set"
          exact
          exact-active-class="bg-gray-200"
        ...
        >
          ...
          <span class="text-gray-700">Question Set</span>
        </router-link>
        <router-link
          to="/question"
          exact
